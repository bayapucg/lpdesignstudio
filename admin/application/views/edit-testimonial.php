      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" action="<?php echo base_url(); ?>welcome/updatetestimonial/<?php  echo $testimonial->id; ?>" enctype="multipart/form-data">
               <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <label for="exampleInputPassword1">Profession</label>
                       <input type="text"  class="form-control" value="<?php echo $testimonial->profession; ?>" name="profession" required>
                </div>
                 <div class="form-group">
                  <label for="exampleInputPassword1">Content</label>
                       <textarea  class="form-control" id="editor1" name="content" ><?php echo $testimonial->content; ?></textarea>
                </div>
               </div>
