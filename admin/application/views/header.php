    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p style="text-transform:uppercase;"><?php echo $this->session->userdata('admin_name');?></p>
      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<li><a href="<?php echo base_url();  ?>welcome/dashboard"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
		<li><a href="<?php echo base_url();  ?>welcome/whatwedo"><i class="fa fa-dashboard"></i> <span>What we do?</span></a></li>
		<li><a href="<?php echo base_url();  ?>welcome/ourprocess"><i class="fa fa-dashboard"></i> <span>Our Process</span></a></li>
		<li><a href="<?php echo base_url();  ?>welcome/testimonial"><i class="fa fa-dashboard"></i> <span>Testimonials</span></a></li>
