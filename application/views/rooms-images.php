...
:checked + label img {
  ...
  <li><input type="checkbox" id="cb1" />
    <label for="cb1"><img src="<?php echo base_url();  ?>assets/images/services/p3_a.jpg" width="110%"></label>
  </li>
  <li><input type="checkbox" id="cb2" />
    <label for="cb2"><img src="<?php echo base_url();  ?>assets/images/services/p3_a.jpg" width="100%"></label>
  </li>
  <li><input type="checkbox" id="cb3" />
    <label for="cb3"><img src="<?php echo base_url();  ?>assets/images/services/p3_a.jpg" width="100%"></label>
  </li>
  <li><input type="checkbox" id="cb4" />
    <label for="cb4"><img src="<?php echo base_url();  ?>assets/images/services/p3_a.jpg" width="100%"></label>
  </li>
</ul>
